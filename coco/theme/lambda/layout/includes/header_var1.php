...
<div class="container-fluid">    
	...
	if (empty($CFG->loginhttps)) {
		...
		if (!isloggedin() or isguestuser()) {
			...
			$login_link_url = '';
			$login_link_txt = '';
			if ($login_link=='1') {$login_link_url = $wwwroot.'/login/new-registration.php'; $login_link_txt = get_string('startsignup');}
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-8 text-center">
						<div class="forgotpass">
									...
									<?php } ?> | 									<?php
									$login_link_url_forget = $wwwroot.'/login/forgot_password.php'; 
									?>
									<a target="_self" href="<?php echo $login_link_url_forget; ?>">
										<?php
									echo "Forgotten Account ?";//$login_link_txt_forget = get_string('forgotten');
									?>
								</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-4 text-center" >
						...
						<div class="potentialidp" style="margin-left: 2px">
							<a class="btn btn-oauth2" href="<?php echo $idp['url']->out(); ?>" title="Login with <?php echo s($idp['name']); ?>">
						...
						<div id="block-login">
							...
							<input id="inputName" class="span2" type="text" name="username" placeholder="<?php echo $username; ?>">
								...
								<div class="forgotpass">
									...
									<a target="_self" href="<?php echo $login_link_url_forget; ?>">
										<?php
									echo $login_link_txt_forget = get_string('forgotten');
									?>
								</div>
