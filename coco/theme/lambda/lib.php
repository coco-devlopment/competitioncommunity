...
function lambda_set_block_style($css, $block_style) {
    ...
    if ($block_style == "1") {
        ...
        $replacement = '#block-region-side-post .block,#block-region-side-pre .block,.hidden-blocks .block{background:#fff;border:none;padding-top:0}#block-region-side-post .block .header,#block-region-side-pre .block .header,.hidden-blocks .block .header{margin:0 -12px;background:#f2f2f2;box-shadow:0 0 0 1px rgba(0,0,0,.1) inset;padding-right:12px;padding-top:0;height:37px}.block .header .title{background-image:none;min-height:27px!important}#block-region-side-post .block .header .title h2::before,#block-region-side-pre .block .header .title h2::before,.hidden-blocks .block .header .title h2::before{border-radius:0;font-size:20px;padding:0;width:37px;margin:0 5px 0 0;line-height:37px}#block-region-side-post .block .header .title h2,#block-region-side-pre .block .header .title h2,.hidden-blocks .block .header .title h2{padding-left:10px}#region-main .block .header .title{background:#f4f4f4;box-shadow:0 0 0 1px rgba(0,0,0,.1) inset;margin-bottom:10px;height:37px;padding:0 10px 0 0!important}.block .header .title h2,.block h3.main{line-height:36px;padding:0!important;text-transform:none;display:block;text-overflow:ellipsis;white-space:nowrap;overflow:hidden}#region-main .block .header .title h2::before{border-radius:0;font-size:21px;padding:0;width:40px;line-height:37px;margin:0 10px 0 0!important}.block .header .block_action{padding:4px 0}#sidebar #block-region-side-pre{background:#fff}#sidebar #block-region-side-pre .block .header{box-shadow:none}';
		$css = str_replace($tag, $replacement, $css);
	}
	else { 
		$css = str_replace($tag, "", $css);
